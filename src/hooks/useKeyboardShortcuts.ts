...
import { BRUSH_MIN, BRUSH_MAX, BRUSH_STEP } from "../constants";
...
export function useKeyboardShortcuts(
  ...
  }, [setTool, setBrushLevel, setBrushSize, dispatch, announce, endPan, setShowHelp, setCursorMode, setShowNewCanvas, t]);
}
