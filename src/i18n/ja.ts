...
export const ja = {
  ...
  theory_dice_net_cut_edge: "切断辺 M₃–R₂（折ると接続）",
  ...
  theory_mixing_input_hint: "入力を押して二色・三色を選択",
  ...
  theory_stella_tetra_lines: "距離2のテトラ：T0（π=0）は実線、T1（π=1）は破線",
  ...
  theory_stella_distance_2_annotation: "2チャンネル反転は同じテトラ内へ：T0の6本は実線、T1の6本は破線。",
